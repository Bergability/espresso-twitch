...
const customRewardSettings: Input<CustomReward>[] = [
    {
        ...
        helper: 'Not seeing your reward? You have to let Espresso create the reward in order for it to be allowed to manage it. Click the following button to create a reward.',
    },
    {
        type: 'button',
...
espresso.triggers.register({
    ...
    variables: [
        { name: 'message', description: 'The chat message sent with the reward. This will be blank if no message is required.' },
